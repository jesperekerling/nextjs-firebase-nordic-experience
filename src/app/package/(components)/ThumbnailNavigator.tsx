      ...
      {images.length > 1 && (
        <>
          <button
            ...
            className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-black text-2xl bg-opacity-80 text-white py-3 px-4 rounded-full font-bold"
          >
            &lt;
          </button>
          <button
            onClick={handleNextImage}
            className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-black text-2xl bg-opacity-80 text-white py-3 px-4 rounded-full font-bold"
          >
            &gt;
          </button>
        </>
